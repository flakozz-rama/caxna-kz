...
import { useSpecialProjects, useDeleteSpecialProject } from "@/lib/api"
...
export default function ProjectsPage() {
  ...
  const handleDelete = async (id: string, title: string) => {
    try {
      ...
      toast({
        title: "Сәтті!",
        description: `"${title}" жобасы сәтті жойылды`,
      });
    } catch (error: any) {
      toast({
        title: "Қате!",
        description: error.message || "Жоба жою кезінде қате орын алды",
        variant: "destructive",
      });
    }
  };
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <AlertDialog>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          <AlertDialogTitle>Жобаны жою</AlertDialogTitle>
                          <AlertDialogDescription>
                            Сіз шынымен "{project.title}" жобасын жойғыңыз келетініне сенімдісіз бе? 
                        ...
                        <AlertDialogFooter>
                          ...
                          <AlertDialogAction
                            onClick={() => handleDelete(project.id.toString(), project.title)}
