  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <div className="flex items-center gap-4 mb-6">
        <Link href="/admin/suqbattar">
          <Button variant="ghost" className="p-2">
            <ArrowLeft className="w-5 h-5" />
          </Button>
        </Link>
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Жаңа сұхбат қосу</h1>
          <p className="text-gray-600 mt-1">Сұхбат ақпаратын толтырыңыз</p>
        </div>
      </div>
            ...
            <CardContent className="space-y-6">
              <div>
                ...
                <Input
                  ...
                  placeholder="Сұхбат атауын енгізіңіз"
                  className="text-base p-3 h-12"
                />
              </div>

              <div>
                <Label htmlFor="interviewee" className="text-base font-medium mb-2 block">
                  Сұхбаттасушы *
                </Label>
                <Input
                  id="interviewee"
                  ...
                  placeholder="Сұхбаттасушы атын енгізіңіз"
                  className="text-base p-3 h-12"
                />
              </div>
              ...
              <div>
                ...
                <Textarea
                  ...
                  placeholder="Сұхбат мазмұнын жазыңыз..."
