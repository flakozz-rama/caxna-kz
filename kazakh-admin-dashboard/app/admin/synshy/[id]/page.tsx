    ...
    return (
      <div className="p-6">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Рецензия</h1>
    ...
    return (
      <div className="p-6">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Рецензия табылмады</h1>
            <p className="text-gray-600 mt-1">Рецензия жүктеу кезінде қате орын алды</p>
          </div>
        </div>
        <div className="text-center py-12">
          <p className="text-red-600 mb-4">Рецензия табылмады немесе жойылған</p>
          <Link href="/admin/synshy">
            <Button className="bg-blue-600 hover:bg-blue-700 text-white">
              Рецензиялар тізіміне оралу
            </Button>
          </Link>
        </div>
      </div>
    ...
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-1">Рецензия ақпараты</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2">
          <Card>
            <CardHeader>
              <CardTitle>Рецензия мазмұны</CardTitle>
            </CardHeader>
            <CardContent>
        ...
        <div className="space-y-6">
          <Card>
            <CardHeader>
              <CardTitle>Рецензия ақпараты</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              {review.publishedAt && (
                <div className="flex items-center gap-2">
                  <Calendar className="w-4 h-4 text-gray-400" />
                  <span className="text-sm text-gray-600">
                    Жарияланған: {new Date(review.publishedAt).toLocaleDateString('kk-KZ')}
                  </span>
                </div>
              )}
