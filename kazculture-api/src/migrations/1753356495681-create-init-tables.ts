...
export class CreateInitTables1753356495681 implements MigrationInterface {
    name = 'CreateInitTables1753356495681'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "videos" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "isActive" boolean NOT NULL DEFAULT true, "title" character varying(500) NOT NULL, "description" text, "duration" character varying(10), "thumbnail_url" character varying, "url" character varying NOT NULL, "category" "public"."videos_category_enum" NOT NULL DEFAULT 'culture', "status" "public"."videos_status_enum" NOT NULL DEFAULT 'draft', "views" integer NOT NULL DEFAULT '0', "published_at" TIMESTAMP, "author_id" character varying, "tags" text array NOT NULL DEFAULT '{}', CONSTRAINT "PK_e4c86c0cf95aff16e9fb8220f6b" PRIMARY KEY ("id"))`);
