...
export class ArnaiyZhobalarController {
  ...
  async findAll(
    ...
    return this.arnaiyZhobalarService.findAll(paginationDto, languageDto.lang);
  }
  ...
  async getFeatured(
    ...
    return this.arnaiyZhobalarService.getFeatured(languageDto.lang, limit);
  }
  ...
  async findBySlug(
    ...
    return this.arnaiyZhobalarService.findBySlug(slug, languageDto.lang);
  }
  ...
  async findAllAdmin(
    ...
    return this.arnaiyZhobalarService.findAll(
      paginationDto,
      'kaz',
      status as any,
    );
